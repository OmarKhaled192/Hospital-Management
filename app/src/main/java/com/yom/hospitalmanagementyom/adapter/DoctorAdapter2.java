...
public class DoctorAdapter2 extends RecyclerView.Adapter<DoctorAdapter2.ViewHolder>{

    private final Context context;
    private final List<Doctor> doctors;
    public DoctorAdapter2(Context context, List<Doctor> doctors){
        this.context=context;
        this.doctors=doctors;
    }

    @NonNull
    public DoctorAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.item_manger,parent,false);
        return new DoctorAdapter2.ViewHolder(v);
    }
